                  ...
                  children: [
                      ...
                      decoration: InputDecoration(
                        focusedBorder: OutlineInputBorder(
                          ...
                          borderSide: const BorderSide(
                            ...
                            color: Color(
                                0xff00afe9), // Substitua pela cor desejada
                          ),
                        ),
                        label:
                            const Text('Loja', style: TextStyle(fontSize: 20)),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                          ...
                          label: const Text('Documento para faturação',
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                          ...
                          label: const Text('Documento para reembolso',
                              style: TextStyle(fontSize: 20)),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                          )),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                          ...
                          label: const Text('Documento para conta corrente',
                              style: TextStyle(fontSize: 20)),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                          )),
